...
<div class="page-header">
    <h1>Patient Queue</h1>
    <p>Dr. {{ $doctor->first_name }} {{ $doctor->last_name }} &middot; {{ $doctor->department->name }} &middot; Pending appointment requests</p>
</div>
...
@if($appointments->isEmpty())
    <div class="card empty-state">
        ...
        <p style="margin-top:6px;font-size:0.88rem;color:#a0b8a8;">Check back later or view your accepted patients.</p>
...
@else
    ...
    <div style="margin-bottom:20px;">
        <span style="background:#fef9e7;color:#9a7d0a;font-size:0.88rem;font-weight:700;padding:6px 16px;border-radius:99px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div style="font-size:0.8rem;color:#5a8a6e;">{{ $appt->type }}</div>
                    </td>
                    <td>{{ $appt->type }}</td>
