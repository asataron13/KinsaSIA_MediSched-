                    ...
                    @foreach($records as $rec)
                        ...
                        <tr>
                            <td style="white-space:nowrap;">
                                {{ \Carbon\Carbon::parse($rec->record_date)->format('M d, Y') }}
                            </td>
                            ...
                            <td
                                style="max-width:180px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:0.88rem;"
                                title="{{ $rec->diagnosis }}"
                            >
                                {{ $rec->diagnosis ?? '—' }}
                            </td>
                            ...
                            <td>
                                <form
                                    method="POST"
                                    action="{{ route('admin.records.destroy', $rec) }}"
